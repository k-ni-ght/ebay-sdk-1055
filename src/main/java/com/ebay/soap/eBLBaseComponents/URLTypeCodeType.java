...
public enum URLTypeCodeType {
   ...
   * <br/>
   * <br/>
   * <code>https://www.sandbox.ebay.com/slr/prd/status/1234567?id_token</code>=<em>Oauth_token</em>, where '1234567' is the identifier of the catalog change request.
   * <br/>
   * <br/>
   * Different base URLs will be returned depending on whether you call <b>GeteBayDetails</b> in Sandbox or Production environment. As of April 2018, this URL and the manage catalog change request flow is only available in the Sandbox environment. This URL and the create catalog product flow will become available in the Production environment in August 2018 with the launch of Product-Based Shopping Experience Phase 2. See the <a href="
   * https://developer.ebay.com/pbse" target="_blank">Product-Based Shopping Experience landing page</a> for more information.
   * <br/>
   * <br/>
   * For more information on getting OAuth access tokens, see our <a href="
