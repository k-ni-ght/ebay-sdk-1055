...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                version="1.0" exclude-result-prefixes="x xml xal">
        ...
        <xsl:copy>
            ...
            <API.XSL.Overrides>
                <Styles>
                    ...
                    <Fonts>
                        <font id="Error" face="Arial, Helvetica, sans-serif" size="2"
                              color="#CC0000"/> <!-- font used in error messages -->
                        <font id="default" face="Verdana,Geneva,Arial,Helvetica"
                              style="font-size:11px"/> <!-- font used in displaying TextMessage -->
                        <font id="non-js-update-section" face="Arial, Helvetica, sans-serif" size="2"
                              color="660000"/> <!-- this font is used in section that appears when JS is disabled. -->
                        <font id="item-specifics-title" face="Arial, Helvetica, sans-serif" style="font-weight: 700"
                              size="2" color="660000"/> <!-- this font is to show ItemSpecifics header. -->
                        <font id="message-style-default" face="Verdana,Geneva,Arial,Helvetica" style="font-size:11px"
                              color="#666666"/> <!-- this font is used in case no fonts were specified for MessageTop/Bottom/Left/Right in PI -->
                    </Fonts>
                    ...
                    <Head>
                        ...
                        <script language="JavaScript">
                            ...
                            hw = window.open(path, "helpwin",
                            "height=465,width=410,scrollbars=yes,status=no,toolbar=no,menubar=no,location=no,resizable=yes,titlebar=no");
                    ...
                    <Images>
                        ...
                        <Image.RequiredMark src="http://pics.ebay.com/aw/pics/asteriskG_10x10.gif" width="10"
                                            height="10"/>
