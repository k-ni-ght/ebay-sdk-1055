...
import com.ebay.soap.eBLBaseComponents.ReviseFixedPriceItemResponseType;
 ...
 * <br> <B>Output property:</B> <code>ReturnedItemID</code> - The unique identifier for the revised item. Note that the <b>ItemID</b> does not change when a listing is revised, so this will be the same <b>ItemID</b> value that was passed in the call request.
 * <br/><br/>
 ...
 * <br> <B>Output property:</B> <code>ReturnedEndTime</code> - This timestamp indicates the date and time when the revised item is scheduled to end on the eBay site. This date/time is calculated by using the <b>StartTime</b> and the the listing duration. This value doesn't change when a listing is revised.
